...
export default function AddVehiclePage() {
    ...
    return (
        <div className="w-full h-[600px] bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 flex items-center justify-center p-6">
            <div className="w-full max-w-4xl bg-white/10 backdrop-blur-xl p-10 rounded-2xl border border-white/20 shadow-2xl text-white">
                ...
                <textarea
                    ...
                    rows="4"
                    className="input-style w-full mt-6"
                />

                <button onClick={handleAddVehicle} className="bg-blue-500 text-white p-2 rounded hover:bg-blue-600">
                    Add
                </button>
